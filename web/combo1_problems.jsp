...
<%@page language="java" import ="java.sql.*" %> 
 ...
 String cvahed = request.getParameter("cvahed");
 String buffer="<select id='problems'"
         + "onchange='ini_item()' style='position:absolute;top:154px;left:2%;font:16px arial;width:20%;height:3.5%;'>";
...
try
  {
      ...
      ass.st.setInt(1, Integer.parseInt(cvahed));
