...
HashMap hm = null;
            ...
            try {
               ...
               ass.query = "SELECT * from resultx_rahkar WHERE cvahed=? ORDER BY radif";
            ...
            File reportFile = new File(application.getRealPath("reports/report_resultx_rahkar.jasper"));//your report_name.jasper file
