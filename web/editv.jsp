...
try{
   ...
   ass.con = DriverManager.getConnection(ass.url, ass.id, ass.pass);
       ...
       if (ass.rs1.next()) {
          if ((ass.rs1.getInt("pvazn")==0 || ass.rs1.getInt("pproblem")==0 ||ass.rs1.getInt("ppayan")==1 ) )  {
              ass.rs1.close();
              ass.st.close();
              ass.con.close();
              data = ":" + "1";
       ...
       ass.rs1=ass.st.executeQuery();
       if (ass.rs1.next()) {
          if (ass.rs1.getInt("tv")==1  && cnaghsh0_==1 ) {
              ass.rs1.close();
              ass.st.close();
              ass.con.close();
              data = ":" + "2";
          ...
          if (ass.rs1.getInt("tv")==1  && cnaghsh0_==2 ) {
          ...
          if (ass.rs1.next()) {
             ...
             ass.st.setString(2, ass.date_convert());
          ...
          if (ass.rs1.next()) {
             ...
             ass.st.setString(6, ass.date_convert());
             ass.st.executeUpdate();
             ass.rs1.close(); 
             ass.st.close();
          }
