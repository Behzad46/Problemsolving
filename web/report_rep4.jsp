...
HashMap hm = null;
            ...
            try {
               ...
               ass.query = "SELECT * from rep_rep4 WHERE vahed=? ORDER BY radif";
            ...
            File reportFile = new File(application.getRealPath("reports/report_rep4.jasper"));//your report_name.jasper file
