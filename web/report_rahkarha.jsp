...
HashMap hm = null;
            ...
            try {
               ...
               ass.query = "SELECT * from rep_rahkarha";
               ass.rs=ass.st.executeQuery(ass.query);
                ...
                while (ass.rs.next()) {
                     ...
                     hm.put("rahkar",ass.rs.getString("rahkar").trim());
                     hm.put("text_oknok",ass.rs.getString("text_oknok").trim());
            ...
            File reportFile = new File(application.getRealPath("reports/report_rahkarha.jasper"));//your report_name.jasper file
