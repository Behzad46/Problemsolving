...
try{   
                ...
                while (ass.rs.next()) {  
                    ass.query1 = "UPDATE panel SET  pelaat=?,pvazn=? WHERE id=?";
                    ass.st1 = ass.con.prepareStatement(ass.query1);
                    ass.st1.setInt(1, r110);
                    ass.st1.setInt(2, r210);
                    ass.st1.setString(3, ass.rs.getString("id"));
                ...
                if (c210==1) {
                   ...
                   ass.st1 = ass.con.prepareStatement(ass.query1);
                   ass.st1.setString(1, ass.date_convert());
