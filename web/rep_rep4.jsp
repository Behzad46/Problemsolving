...
<meta name="viewport" content="width=device-width, initial-scale=1">
        <title>Analysed Issues In Committees</title>
...
<body onload="validation()">
 <input type="button" value="Back"  onclick="back()" title="Back" style="position:relative;top:16px;left:2%;width:70px;height:30px">   
    <h1 style="position: relative;top:200px">Analysed Issues In Committees</h1>
<a id="Show_table" >
</a>
<section>
<form METHOD="POST" name="fdata" action="">
<font Style="position:absolute;top:66px;left:5%;font: 16px Arial;
    ...
    <input type="date" name="dates" 
           id="dates" value="" onchange="set_dates()" 
    ...
    <input type="date" name="datee"
           id="datee" value="" onchange="set_datee()"
...
<select id="reports"  onchange="rep_rep4()" style='position:absolute;top:238px;left:5%;font:16px arial;width:20%;height:3.5%;'>
    <option>
        Select...
    </option>
    <option>
...
function ini_vaheds(){
   ...
   crep_rep4(fdata.ds.value,fdata.de.value,document.getElementById("cvahed").value);
}
...
var xmlHttp3;
function crep_rep4(str,str1,str2){
...
function rep_rep4(){
   for(ii=0;ii<document.getElementById("reports").options.length;ii++){
    if(document.getElementById('reports').selectedIndex==1){
       ...
       a='report_rep4_xls_e.jsp?vds='+vds;
       window.open(a);
       break;
    }
    ...
    if(document.getElementById('reports').selectedIndex==3){
       ...
       var fn;
       vds=document.getElementById('cvahed').value;
       fn="/reports/report_rep4_e.jasper";
