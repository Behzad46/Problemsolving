...
<%
    ...
    String vds_ = request.getParameter("vds1"); 
...
function mail(){
    ...
    str6="<%=vds_%>";
    str7="<%=strk_%>";
   var url= 'mail_rep7.jsp';
   url += '?recipient=' +str1+'&subject='+str2+'&content='+str3+'&reportname='+str4+'&sender='+str5+'&vds1='+str6+'&strk1='+str7;
   window.open(url);
}
var xmlHttp3;
function validation(){
