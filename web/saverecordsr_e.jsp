                ...
                if (ass.rs.next()) {  
                    if (radifi!=0) {
                       ...
                       if (ass.rs1.next()) {
                        ...
                        ass.query3 = "INSERT INTO rahkar (radif,id,elaat,usern,cvahed,rahkar,oknok,mojri,dates,datee,code_id,problem_id)"
                        + " values (?,?,?,?,?,?,?,?,?,?,?,?) ";
                        ...
                        ass.st1.setInt(7, 0);
                        ass.st1.setString(8, "");
                        ass.st1.setString(9, ass.date_milady());
                        ass.st1.setString(10, "");
                        ass.st1.setString(11, c_id);
                        ass.st1.setString(12, strkeyp);
                        ass.st1.executeUpdate();
                    }
                    data = ":" + "0";
                    out.print(data);
